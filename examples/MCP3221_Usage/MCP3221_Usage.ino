...
#define MCP3221_ADDR  0x4D              // B01001101, DEC: 77 - I2C READ ADDRESS of the MCP3221 (Change as needed based on specific device part number)
...
MCP3221 MCP3221(MCP3221_ADDR);          // Constructs the MCP3221 object with the above address
